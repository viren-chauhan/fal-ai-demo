...
export default function Home() {
  return (
    <div className="min-h-screen min-w-screen bg-[#111419] flex flex-col justify-between gap-2 p-2">
      <h1 className="text-white text-2xl font-semibold">General Image</h1>
      <div className="flex flex-row justify-between gap-5">
        <div className="flex-grow bg-[#2c2d44] w-3/4 rounded-md p-3">
          ...
          <div>
            <div className="flex flex-row justify-between gap-3 pt-4">
              ...
              <div className="w-1/2 h-40 rounded-md border bg-[#2e334d] p-5 flex flex-col justify-between">
        ...
        <div className="flex-grow w-1/4 bg-[#2c2d44] rounded-md p-3">
